...
**Ask to URL** is a web app that extracts and summarizes text from a given webpage URL using Google Generative AI. With a simple interface, it retrieves the content from the URL, summarizes it, and displays both the original and summarized text.
...
- Libraries: Flask, Requests, BeautifulSoup, LangChain, dotenv

## Installation
1. **Clone the Repo**:
   ```bash
   git clone https://github.com/yourusername/ask-to-url.git
   cd ask-to-url
   ```
...
1. **Run the App**:
   ...
   python app.py
   ```
2. **Use the Interface**: Go to `http://127.0.0.1:5000/`, enter a URL, and see both the raw and summarized text.

## Project Structure
- **app.py** - Main app
- **templates/** - Contains HTML templates
- **.env** - Stores API key (not included in repo)
...
![image](https://github.com/user-attachments/assets/29fcafd6-e57c-4159-b04c-aea6fa0974fd)


![image](https://github.com/user-attachments/assets/1ae657df-8866-4abe-be2b-feb2f1b7ed55)
